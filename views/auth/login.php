...
<p class="descripcion-pagina">Ingrese sus datos</p>

<!-- Este es el formulario de inicio de sesión -->
<form class="formulario-pag-login" method="POST" action="/"> <!-- INDEX.PHP -->
    ...
    <div class="contenedor-pag-login-boton">
        <input type="submit" class="boton-pag-login" value="Iniciar sesión">
    </div>
</form>
